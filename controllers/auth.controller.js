...
// List of allowed branches for students
...
// List of allowed departments for faculty (same as branches)
...
export const registerFaculty = async (req, res) => {
  try {
    ...
    // Validate that department is in allowed list
    ...
    // Check if department exists in database, if not create it
